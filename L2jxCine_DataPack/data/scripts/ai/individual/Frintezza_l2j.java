 ...
 * 
 */
public class Frintezza_l2j extends AbstractNpcAI
{
	...
	// Boss: Frintezza
	public Frintezza_l2j(String name, String descr)
	{
		super(name,descr);
	...
	{
		new Frintezza_l2j(Frintezza_l2j.class.getSimpleName(), "ai/individual");
	}
}