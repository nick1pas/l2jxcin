 ...
 * @author Kerberos
 */
public class Valakas_l2j extends AbstractNpcAI
{
	private int i_ai0 = 0;
	private int i_ai1 = 0;
	private int i_ai2 = 0;
	...
	// Boss: Valakas
	public Valakas_l2j(String name, String descr)
	{
		super(name, descr);
		int[] mob =
		{
	...
	{
		new Valakas_l2j(Valakas_l2j.class.getSimpleName(), "ai/individual");
	}
