...
from net.xcine.gameserver.model.entity.siege.clanhalls import DevastatedCastle
...
from net.xcine.gameserver.managers import ClanHallManager
from net.xcine.util.random import Rnd
from net.xcine.gameserver.model import L2Clan
from net.xcine.gameserver.model import L2ClanMember
