...
import net.xcine.gameserver.network.serverpackets.GameGuardQuery;
...
public class nProtect
{
	...
	private nProtect()
	{
		...
		try
		{
			clazz = Class.forName("net.xcine.protection.main");
		...
		{
			if(Config.DEBUG)
				_log.warning("nProtect System will be not loaded due to ClassNotFoundException of 'net.xcine.protection.main' class" );
		}
