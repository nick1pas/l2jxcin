...
public class SkillTreeData
{
	...
	private SkillTreeData()
	{
		...
		File file = new File(Config.DATAPACK_ROOT + "/data/stats/skill_tree.xml");
		if(!file.exists())
		{
		...
		File f = new File(Config.DATAPACK_ROOT + "/data/stats/fishing_skill_tree.xml");
		if(!f.exists())
		{
		...
		File f2 = new File(Config.DATAPACK_ROOT + "/data/stats/enchant_skill_tree.xml");
		if(!f2.exists())
		{
...
//									String type = String.valueOf(t2.getAttributes().getNamedItem("type").getNodeValue());
		...
		File f1 = new File(Config.DATAPACK_ROOT + "/data/stats/pledge_skill_tree.xml");
		if(!f1.exists())
		{
