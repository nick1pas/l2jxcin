...
import net.xcine.gameserver.communitybbs.Manager.AdminBBSManager;
...
public class AdminBBS implements IAdminCommandHandler
{
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.handler.IAdminCommandHandler#useAdminCommand
	 * (java.lang.String, net.xcine.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.handler.IAdminCommandHandler#getAdminCommandList()
	 */
	@Override
