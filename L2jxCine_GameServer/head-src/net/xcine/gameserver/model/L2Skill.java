...
import net.xcine.gameserver.skills.l2skills.L2SkillChargeDmg;
import net.xcine.gameserver.skills.l2skills.L2SkillChargeEffect;
import net.xcine.gameserver.skills.l2skills.L2SkillCreateItem;
import net.xcine.gameserver.skills.l2skills.L2SkillDefault;
import net.xcine.gameserver.skills.l2skills.L2SkillDrain;
import net.xcine.gameserver.skills.l2skills.L2SkillSeed;
import net.xcine.gameserver.skills.l2skills.L2SkillSignet;
...
public abstract class L2Skill
{
	...
	public final L2Object[] getTargetList(L2Character activeChar, boolean onlyFirst, L2Character target)
	{
		...
		// The skill can only be used on the L2Character targeted, or on the caster itself
			...
			case TARGET_AURA:
			{
				...
				{
					if(obj == null || !(activeChar instanceof L2Playable) && !(obj instanceof L2Playable))
						continue;
					...
					if(src != null && (obj instanceof L2Attackable || obj instanceof L2Playable))
					{
			...
			case TARGET_AREA:
			{
				...
				if(!(target instanceof L2Attackable || target instanceof L2Playable || target instanceof L2NpcInstance) || //   Target is not L2Attackable or L2Playable or L2NpcInstance
					...
					if(!target.isAlikeDead() && target != activeChar)
					{
						...
						if(src != null) // caster is L2Playable and exists
						{
							...
							if(obj instanceof L2PcInstance){
								...
								if( ((src._inEvent ||  src._inEventVIP) && (!trg._inEvent && !trg._inEventVIP)) || ((trg._inEvent || trg._inEventVIP) && (!src._inEvent && !src._inEventVIP))  ){
									continue;
								}
	...
	public boolean checkPartyClan(L2Character activeChar, L2Object target)
	{
		if(activeChar instanceof L2PcInstance && target instanceof L2PcInstance)
		{
			...
			//to be fixed for mixed events status (in TvT joining phase, someone can attack a partecipating CTF player with area attack) 
			if( ((activeCh._inEvent || activeCh._inEventVIP) && (!targetChar._inEvent  && !targetChar._inEventVIP)) || ((targetChar._inEvent || targetChar._inEventVIP) && (!activeCh._inEvent && !activeCh._inEventVIP))  ){
				return true;
			}
