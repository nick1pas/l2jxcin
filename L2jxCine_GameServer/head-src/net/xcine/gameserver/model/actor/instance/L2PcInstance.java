...
import net.xcine.gameserver.cache.WarehouseCacheManager;
...
import net.xcine.gameserver.model.PcWarehouse;
import net.xcine.gameserver.model.PetInventory;
import net.xcine.gameserver.model.PlayerStatus;
...
import net.xcine.gameserver.network.serverpackets.ExPCCafePointInfo;
...
import net.xcine.gameserver.network.serverpackets.MagicSkillCanceld;
...
import net.xcine.gameserver.network.serverpackets.TitleUpdate;
...
import net.xcine.gameserver.templates.L2ArmorType;
...
public final class L2PcInstance extends L2Playable
{
	...
	public class AIAccessor extends L2Character.AIAccessor
	{
		...
		/* (non-Javadoc)
		 * @see net.xcine.gameserver.model.L2Character.AIAccessor#doCast(net.xcine.gameserver.model.L2Skill)
		 */
		@Override
...
private int _reviveRequested = 0;
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#updatePvPFlag(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#revalidateZone(boolean)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Object#onActionShift(net.xcine.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
...
//	}
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#getLevelMod()
	 */
	@Override
...
*/
	...
	*/
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#doRevive()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#doRevive(double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#onTeleported()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#updatePosition(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#addExpAndSp(long, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#reduceCurrentHp(double, net.xcine.gameserver.model.L2Character)
	 */
	@Override
	...
	*/
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#sendDamageMessage(net.xcine.gameserver.model.L2Character, int, boolean, boolean, boolean)
	 */
	@Override
