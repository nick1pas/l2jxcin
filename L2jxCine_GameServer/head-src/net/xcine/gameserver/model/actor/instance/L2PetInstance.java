...
import net.xcine.gameserver.model.actor.stat.PetStat;
...
public class L2PetInstance extends L2Summon
{
	...
	public final L2PetData getPetData()
	{
		if(_data == null)
		{
			_data = L2PetDataData.getInstance().getPetData(getTemplate().npcId, getStat().getLevel());
		}
	...
	class FeedTask implements Runnable
	{
		...
		public void run()
		{
			try
			{
				...
				int foodId = L2PetDataData.getFoodItemId(getTemplate().npcId);
				if(foodId == 0)
					return;
	...
	public L2PetInstance(int objectId, L2NpcTemplate template, L2PcInstance owner, L2ItemInstance control)
	{
		...
		_mountable = L2PetDataData.isMountable(npcId);
	}

	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#getStat()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#getSummonType()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#onAction(net.xcine.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#getControlItemId()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#setPkKills(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#getSecondaryWeaponInstance()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#getSecondaryWeaponItem()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#getInventory()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#doPickupItem(net.xcine.gameserver.model.L2Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#deleteMe(net.xcine.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#doDie(net.xcine.gameserver.model.L2Character)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#giveAllToOwner()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#store()
	 */
	@Override
	public void store()
	{
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#unSummon(net.xcine.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#getExpForThisLevel()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Summon#getExpForNextLevel()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#getAccuracy()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#getCriticalHit(net.xcine.gameserver.model.L2Character, net.xcine.gameserver.model.L2Skill)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#getEvasionRate(net.xcine.gameserver.model.L2Character)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#getRunSpeed()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#getPAtkSpd()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#getMAtkSpd()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#getMAtk(net.xcine.gameserver.model.L2Character, net.xcine.gameserver.model.L2Skill)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#getMDef(net.xcine.gameserver.model.L2Character, net.xcine.gameserver.model.L2Skill)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#getPAtk(net.xcine.gameserver.model.L2Character)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#getPDef(net.xcine.gameserver.model.L2Character)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#getSkillLevel(int)
	 */
	@Override
