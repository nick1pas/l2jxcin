...
public final class L2RaidBossInstance extends L2MonsterInstance
{
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.L2Character#isRaid()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.actor.instance.L2MonsterInstance#getMaintenanceInterval()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.model.actor.instance.L2MonsterInstance#doDie(net.xcine.gameserver.model.L2Character)
	 */
	@Override
