...
{
	public static final Logger _log = Logger.getLogger(AutoSpawn.class.getName());
	...
	private class AutoSpawner implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_log.warning("AutoSpawnHandler: An error occurred while initializing spawn instance (Object ID = " + _objectId + ")");
			}
		}
	}
	...
	private class AutoDespawner implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_log.warning("AutoSpawnHandler: An error occurred while despawning spawn (Object ID = " + _objectId + ")");
			}
		}
	}
