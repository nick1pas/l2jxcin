...
import net.xcine.gameserver.managers.PacketsLoggerManager;
...
import net.xcine.netcore.IClientFactory;
import net.xcine.netcore.IMMOExecutor;
import net.xcine.netcore.IPacketHandler;
import net.xcine.netcore.MMOConnection;
import net.xcine.netcore.ReceivablePacket;
import net.xcine.util.PacketsFloodProtector;
	...
	public ReceivablePacket<L2GameClient> handlePacket(ByteBuffer buf, L2GameClient client)
	{
		...
		switch(state)
		{
			...
			case IN_GAME:{
				...
				if(!net.xcine.netcore.Config.getInstance().LIST_ALLOWED_OFFLINE_OPCODES.contains(opcode)){
...
*/
						...
						if(!net.xcine.netcore.Config.getInstance().LIST_ALLOWED_OFFLINE_OPCODES2.contains(opcode2)){
	...
	private void printDebug(int opcode, ByteBuffer buf, GameClientState state, L2GameClient client)
	{
		...
		if (!net.xcine.netcore.Config.getInstance().PACKET_HANDLER_DEBUG)
			return;
