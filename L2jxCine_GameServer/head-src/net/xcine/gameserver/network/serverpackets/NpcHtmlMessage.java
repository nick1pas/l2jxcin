...
import net.xcine.gameserver.network.clientpackets.RequestBypassToServer;
...
public class NpcHtmlMessage extends L2GameServerPacket
{
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.network.serverpackets.L2GameServerPacket#runImpl()
	 */
	@Override
	public void runImpl()
	{
	...
	/* (non-Javadoc)
	 * @see net.xcine.gameserver.network.serverpackets.L2GameServerPacket#writeImpl()
	 */
	@Override
