...
import net.xcine.gameserver.script.DateRange;
import net.xcine.gameserver.script.EngineInterface;
import net.xcine.gameserver.script.EventDroplist;
import net.xcine.gameserver.script.Expression;
...
public class FaenorInterface implements EngineInterface
{
	 ...
	 * 
	 * @see net.xcine.gameserver.script.EngineInterface#addQuestDrop(int, int, int, int, int, String, String[])
	 */
	@Override
