...
public final class L2ObjectHashSet<T extends L2Object> extends L2ObjectSet<T>
{
	...
	/* (non-Javadoc)
	 * @see net.xcine.util.L2ObjectSet#size()
	 */
	@Override
	public int size()
	{
	...
	/* (non-Javadoc)
	 * @see net.xcine.util.L2ObjectSet#isEmpty()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.util.L2ObjectSet#clear()
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see net.xcine.util.L2ObjectSet#put(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.util.L2ObjectSet#remove(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.util.L2ObjectSet#contains(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.xcine.util.L2ObjectSet#iterator()
	 */
	@Override
