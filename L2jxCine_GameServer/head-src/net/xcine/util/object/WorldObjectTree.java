...
public class WorldObjectTree<T extends L2Object> extends L2ObjectMap<T>
{
	...
	/**
	 * @see net.xcine.util.object.L2ObjectMap#size()
	 */
	@Override
	public int size()
	{
	...
	/**
	 * @see net.xcine.util.object.L2ObjectMap#isEmpty()
	 */
	@Override
	...
	/**
	 * @see net.xcine.util.object.L2ObjectMap#clear()
	 */
	@Override
	public void clear()
	{
	...
	/**
	 * @see net.xcine.util.object.L2ObjectMap#get(int)
	 */
	@Override
	public T get(int id)
	{
	...
	/**
	 * @see net.xcine.util.object.L2ObjectMap#iterator()
	 */
	@Override
