...
public class ArimanesOfDestruction extends AbstractNpcAI
{
	...
	public ArimanesOfDestruction(String name, String descr)
	{
		super(name, descr);
	...
	{
		new ArimanesOfDestruction(ArimanesOfDestruction.class.getSimpleName(), "ai/group");
	}
}