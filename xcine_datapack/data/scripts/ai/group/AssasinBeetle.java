...
public class AssasinBeetle extends AbstractNpcAI
{
	...
	public AssasinBeetle(String name, String descr)
	{
		super(name, descr);
	...
	{
		new AssasinBeetle(AssasinBeetle.class.getSimpleName(), "ai/group");
	}
}