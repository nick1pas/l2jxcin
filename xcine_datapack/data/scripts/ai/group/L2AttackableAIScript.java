...
{
	protected L2AttackableAIScript(int questId, String name, String descr)
	{
	...
	public static void main(String[] args)
	{
		...
		for (L2NpcTemplate template : NpcTable.getInstance().getAllNpcs())
		{
			try
			{
				if (L2Attackable.class.isAssignableFrom(Class.forName("net.xcine.gameserver.model.actor.instance." + template.getType() + "Instance")))
				{
