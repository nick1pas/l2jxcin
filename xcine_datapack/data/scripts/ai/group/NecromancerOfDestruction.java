...
public class NecromancerOfDestruction extends AbstractNpcAI
{
	...
	public NecromancerOfDestruction(String name, String descr)
	{
		super(name, descr);
	...
	{
		new NecromancerOfDestruction(NecromancerOfDestruction.class.getSimpleName(), "ai/group");
	}
}