...
public class SummonOnAttack extends AbstractNpcAI
{
	...
	public SummonOnAttack(String name, String descr)
	{
		super(name, descr);
		for (int id : mobs)
		{
	...
	{
		new SummonOnAttack(SummonOnAttack.class.getSimpleName(), "ai/group");
	}
}