...
public class IceFairySirra extends AbstractNpcAI
{
	...
	public IceFairySirra(String name, String descr)
	{
		...
		for(int mob : mobs)
		{
			...
			addEventId(mob, QuestEventType.ON_TALK);
			addEventId(mob, QuestEventType.ON_FIRST_TALK);
		}
	...
	public void init()
	{
		_freyasZone = GrandBossManager.getZoneByXYZ(105546, -127892, -2768);
		if(_freyasZone == null)
		{
			_log.warning("IceFairySirraManager: Failed to load zone");
			return;
	...
	public void cleanUp()
	{
		...
		for(L2Npc mob : _allMobs)
		{
			...
			{
				_log.warning("IceFairySirraManager: Failed deleting mob."+ e);
			}
		}
		_allMobs.clear();
	}
	...
	protected void openGates()
	{
		for(int i = 23140001; i < 23140003; i++)
		{
			...
			{
				_log.warning("IceFairySirraManager: Failed closing door"+ e);
			}
		}
	}
