...
public class Q336_CoinsOfMagic extends Quest
{
    ...
    {
        // Demon's Staff
        TRADE_LIST.put(206, new int[] {BELETHS_BLOOD, 1});
        TRADE_LIST.put(206, new int[] {SILVER_DRAGON, 1});
        TRADE_LIST.put(206, new int[] {GOLD_WYRM, 13});
        // Dark Screamer
        TRADE_LIST.put(233, new int[] {BELETHS_GOLD, 1});
        TRADE_LIST.put(233, new int[] {BLOOD_DRAGON, 1});
        TRADE_LIST.put(233, new int[] {SILVER_DRYAD, 1});
        TRADE_LIST.put(233, new int[] {GOLD_GIANT, 1});
        // Widow Maker
        TRADE_LIST.put(303, new int[] {BELETHS_SILVER, 1});
        TRADE_LIST.put(303, new int[] {GOLD_DRAGON, 1});
        TRADE_LIST.put(303, new int[] {BLOOD_SUCCUBUS, 1});
        TRADE_LIST.put(303, new int[] {BLOOD_BASILISK, 2});
        // Sword of Limit
        TRADE_LIST.put(132, new int[] {GOLD_DRAGON, 1});
        TRADE_LIST.put(132, new int[] {SILVER_DRAGON, 1});
        TRADE_LIST.put(132, new int[] {BLOOD_DRAGON, 1});
        TRADE_LIST.put(132, new int[] {SILVER_UNDINE, 1});
        // Demon's Boots
        TRADE_LIST.put(2435, new int[] {MANAKS_GOLD_GIANT, 1});
        // Demon's Stockings
        TRADE_LIST.put(472, new int[] {MANAKS_SILVER_DRYAD, 1});
        TRADE_LIST.put(472, new int[] {SILVER_DRYAD, 1});
        // Demon's Gloves
        TRADE_LIST.put(2459, new int[] {MANAKS_GOLD_GIANT, 1});
        // Full Plate Helm
        TRADE_LIST.put(2414, new int[] {MANAKS_BLOOD_WEREWOLF, 1});
        TRADE_LIST.put(2414, new int[] {GOLD_WYRM, 1});
        TRADE_LIST.put(2414, new int[] {GOLD_GIANT, 1});
        // Moonstone Earring
        TRADE_LIST.put(852, new int[] {NIAS_BLOOD_MEDUSA, 2});
        TRADE_LIST.put(852, new int[] {BLOOD_DREVANUL, 2});
        TRADE_LIST.put(852, new int[] {GOLD_DRAKE, 2});
        TRADE_LIST.put(852, new int[] {GOLD_KNIGHT, 3});
        // Nassens Earring
        TRADE_LIST.put(855, new int[] {NIAS_BLOOD_MEDUSA, 7});
        TRADE_LIST.put(855, new int[] {BLOOD_DREVANUL, 5});
        TRADE_LIST.put(855, new int[] {SILVER_GOLEM, 5});
        TRADE_LIST.put(855, new int[] {GOLD_KNIGHT, 5});
        // Ring of Binding
        TRADE_LIST.put(886, new int[] {NIAS_GOLD_WYVERN, 5});
        TRADE_LIST.put(886, new int[] {GOLD_DRAKE, 4});
        TRADE_LIST.put(886, new int[] {SILVER_GOLEM, 4});
        TRADE_LIST.put(886, new int[] {BLOOD_DREVANUL, 4});
        // Necklace of Protection
        TRADE_LIST.put(916, new int[] {NIAS_SILVER_FAIRY, 5});
        TRADE_LIST.put(916, new int[] {SILVER_FAIRY, 3});
        TRADE_LIST.put(916, new int[] {GOLD_KNIGHT, 3});
        TRADE_LIST.put(916, new int[] {BLOOD_DREVANUL, 3});
    }
    ...
    private static final int[][] PROMOTE = 
    {
        {},	// Grade 0
        {},	// Grade 1
        {BLOOD_BASILISK, BLOOD_SUCCUBUS, GOLD_GIANT, GOLD_WYRM, SILVER_DRYAD, SILVER_UNDINE},	// Grade 2
        {BLOOD_WEREWOLF, GOLD_DRAKE, SILVER_FAIRY, BLOOD_DREVANUL, GOLD_KNIGHT, SILVER_GOLEM}	// Grade 3
    };
    ...
    {
        {TIMAK_ORC_ARCHER, BLOOD_MEDUSA},
        {TIMAK_ORC_SOLDIER, BLOOD_MEDUSA},
        {TIMAK_ORC_SHAMAN, BLOOD_MEDUSA},
        {LAKIN, BLOOD_MEDUSA},
        {TORTURED_UNDEAD, BLOOD_MEDUSA},
        {HATAR_HANISHEE, BLOOD_MEDUSA},
        {SHACKLE, GOLD_WYVERN},
        {TIMAK_ORC, GOLD_WYVERN},
        {HEADLESS_KNIGHT, GOLD_WYVERN},
        {ROYAL_CAVE_SERVANT, GOLD_WYVERN},
        {MALRUK_SUCCUBUS_TUREN, GOLD_WYVERN},
        {FORMOR, SILVER_UNICORN},
        {FORMOR_ELDER, SILVER_UNICORN},
        {VANOR_SILENOS_SHAMAN, SILVER_UNICORN},
        {TARLK_BUGBEAR_HIGH_WARRIOR, SILVER_UNICORN},
        {OEL_MAHUM, SILVER_UNICORN},
        {OEL_MAHUM_WARRIOR, SILVER_UNICORN}
    };
