...
public final class Config
{
	...
	public static final boolean SCRIPT_ALLOW_COMPILATION = false;

	public static final int GM_ACCESS_LEVEL = 0;
    ...
    /** Force full item inventory packet to be sent for any item change */
	...
	public static void load()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			try
			{
				...
				/** Devastated Castle */
				DEVASTATED_DAY = TypeFormat.parseInt(clans.getProperty("DevastatedDay", "1"));
				DEVASTATED_HOUR = TypeFormat.parseInt(clans.getProperty("DevastatedHour", "18"));
				DEVASTATED_MINUTES = TypeFormat.parseInt(clans.getProperty("DevastatedMinutes", "0"));
				/** Partisan Hideout */
				PARTISAN_DAY = TypeFormat.parseInt(clans.getProperty("PartisanDay", "5"));
				PARTISAN_HOUR = TypeFormat.parseInt(clans.getProperty("PartisanHour", "21"));
				PARTISAN_MINUTES = TypeFormat.parseInt(clans.getProperty("PartisanMinutes", "0"));
			}
			catch (Exception e)
			{
				e.printStackTrace();
			...
			try
			{
				...
				RAID_CHAOS_TIME = Integer.parseInt(npcs.getProperty("RaidChaosTime", "30"));
				GRAND_CHAOS_TIME = Integer.parseInt(npcs.getProperty("GrandChaosTime", "30"));
				MINION_CHAOS_TIME = Integer.parseInt(npcs.getProperty("MinionChaosTime", "30"));

				WAIT_TIME_SAILREN = Integer.parseInt(npcs.getProperty("AntharasWaitTime", "30"));
				if (WAIT_TIME_SAILREN < 3 || WAIT_TIME_SAILREN > 60)
					WAIT_TIME_SAILREN = 30;
				WAIT_TIME_SAILREN = WAIT_TIME_SAILREN * 60000;
				
				SPAWN_INTERVAL_SAILREN = Integer.parseInt(npcs.getProperty("IntervalOfSailrenSpawn", "12"));
				if (SPAWN_INTERVAL_SAILREN < 1 || SPAWN_INTERVAL_SAILREN > 192)
					SPAWN_INTERVAL_SAILREN = 12;
				SPAWN_INTERVAL_SAILREN = SPAWN_INTERVAL_SAILREN * 3600000;
				
				RANDOM_SPAWN_TIME_SAILREN = Integer.parseInt(npcs.getProperty("RandomOfSailrenSpawn", "24"));
				if (RANDOM_SPAWN_TIME_SAILREN < 1 || RANDOM_SPAWN_TIME_SAILREN > 192)
					RANDOM_SPAWN_TIME_SAILREN = 24;
				RANDOM_SPAWN_TIME_SAILREN = RANDOM_SPAWN_TIME_SAILREN * 3600000;
			...
			try
			{
				...
				STARTING_ADENA = Integer.parseInt(other.getProperty("StartingAdena", "100"));
				STARTING_ANCIENT = Integer.parseInt(other.getProperty("StartingAncientAdena", "100"));
				EFFECT_CANCELING = Boolean.parseBoolean(other.getProperty("CancelLesserEffect", "True"));
				HP_REGEN_MULTIPLIER = Double.parseDouble(other.getProperty("HpRegenMultiplier", "100")) / 100;
				MP_REGEN_MULTIPLIER = Double.parseDouble(other.getProperty("MpRegenMultiplier", "100")) / 100;
				CP_REGEN_MULTIPLIER = Double.parseDouble(other.getProperty("CpRegenMultiplier", "100")) / 100;
				PLAYER_SPAWN_PROTECTION = Integer.parseInt(other.getProperty("PlayerSpawnProtection", "0"));
				PLAYER_FAKEDEATH_UP_PROTECTION = Integer.parseInt(other.getProperty("PlayerFakeDeathUpProtection", "0"));
				RESPAWN_RESTORE_HP = Double.parseDouble(other.getProperty("RespawnRestoreHP", "70")) / 100;
				MAX_PVTSTORE_SLOTS_DWARF = Integer.parseInt(other.getProperty("MaxPvtStoreSlotsDwarf", "5"));
				MAX_PVTSTORE_SLOTS_OTHER = Integer.parseInt(other.getProperty("MaxPvtStoreSlotsOther", "4"));
				DEEPBLUE_DROP_RULES = Boolean.parseBoolean(other.getProperty("UseDeepBlueDropRules", "True"));
				ALT_GAME_DELEVEL = Boolean.parseBoolean(other.getProperty("Delevel", "True"));
				DEATH_PENALTY_CHANCE = Integer.parseInt(other.getProperty("DeathPenaltyChance", "20"));
				
				INVENTORY_MAXIMUM_NO_DWARF = Integer.parseInt(other.getProperty("MaximumSlotsForNoDwarf", "80"));
				INVENTORY_MAXIMUM_DWARF = Integer.parseInt(other.getProperty("MaximumSlotsForDwarf", "100"));
				INVENTORY_MAXIMUM_QUEST_ITEMS = Integer.parseInt(other.getProperty("MaximumSlotsForQuestItems", "100"));
				INVENTORY_MAXIMUM_PET = Integer.parseInt(other.getProperty("MaximumSlotsForPet", "12"));
				MAX_ITEM_IN_PACKET = Math.max(INVENTORY_MAXIMUM_NO_DWARF, INVENTORY_MAXIMUM_DWARF);
				ALT_WEIGHT_LIMIT = Double.parseDouble(other.getProperty("AltWeightLimit", "1"));
				WAREHOUSE_SLOTS_NO_DWARF = Integer.parseInt(other.getProperty("MaximumWarehouseSlotsForNoDwarf", "100"));
				WAREHOUSE_SLOTS_DWARF = Integer.parseInt(other.getProperty("MaximumWarehouseSlotsForDwarf", "120"));
				WAREHOUSE_SLOTS_CLAN = Integer.parseInt(other.getProperty("MaximumWarehouseSlotsForClan", "150"));
				FREIGHT_SLOTS = Integer.parseInt(other.getProperty("MaximumFreightSlots", "20"));
				ALT_GAME_FREIGHTS = Boolean.parseBoolean(other.getProperty("AltGameFreights", "False"));
				ALT_GAME_FREIGHT_PRICE = Integer.parseInt(other.getProperty("AltGameFreightPrice", "1000"));
			    ENCHANT_CHANCE_WEAPON = Integer.parseInt(other.getProperty("EnchantChanceWeapon", "68"));
	            ENCHANT_CHANCE_ARMOR = Integer.parseInt(other.getProperty("EnchantChanceArmor", "52"));
	            ENCHANT_CHANCE_JEWELRY = Integer.parseInt(other.getProperty("EnchantChanceJewelry", "54"));
	            BLESSED_ENCHANT_CHANCE_WEAPON = Integer.parseInt(other.getProperty("BlessedEnchantChanceWeapon", "68"));
	            BLESSED_ENCHANT_CHANCE_ARMOR = Integer.parseInt(other.getProperty("BlessedEnchantChanceArmor", "52"));
	            BLESSED_ENCHANT_CHANCE_JEWELRY = Integer.parseInt(other.getProperty("BlessedEnchantChanceJewelry", "54"));
				...
				AUGMENTATION_NG_SKILL_CHANCE = Integer.parseInt(other.getProperty("AugmentationNGSkillChance", "15"));
				AUGMENTATION_NG_GLOW_CHANCE = Integer.parseInt(other.getProperty("AugmentationNGGlowChance", "0"));
				AUGMENTATION_MID_SKILL_CHANCE = Integer.parseInt(other.getProperty("AugmentationMidSkillChance", "30"));
				AUGMENTATION_MID_GLOW_CHANCE = Integer.parseInt(other.getProperty("AugmentationMidGlowChance", "40"));
				AUGMENTATION_HIGH_SKILL_CHANCE = Integer.parseInt(other.getProperty("AugmentationHighSkillChance", "45"));
				AUGMENTATION_HIGH_GLOW_CHANCE = Integer.parseInt(other.getProperty("AugmentationHighGlowChance", "70"));
				AUGMENTATION_TOP_SKILL_CHANCE = Integer.parseInt(other.getProperty("AugmentationTopSkillChance", "60"));
				AUGMENTATION_TOP_GLOW_CHANCE = Integer.parseInt(other.getProperty("AugmentationTopGlowChance", "100"));
				AUGMENTATION_BASESTAT_CHANCE = Integer.parseInt(other.getProperty("AugmentationBaseStatChance", "1"));
				
				KARMA_PLAYER_CAN_BE_KILLED_IN_PZ = Boolean.parseBoolean(other.getProperty("KarmaPlayerCanBeKilledInPeaceZone", "False"));
				KARMA_PLAYER_CAN_SHOP = Boolean.parseBoolean(other.getProperty("KarmaPlayerCanShop", "True"));
				KARMA_PLAYER_CAN_USE_GK = Boolean.parseBoolean(other.getProperty("KarmaPlayerCanUseGK", "False"));
				KARMA_PLAYER_CAN_TELEPORT = Boolean.parseBoolean(other.getProperty("KarmaPlayerCanTeleport", "True"));
				KARMA_PLAYER_CAN_TRADE = Boolean.parseBoolean(other.getProperty("KarmaPlayerCanTrade", "True"));
				KARMA_PLAYER_CAN_USE_WH = Boolean.parseBoolean(other.getProperty("KarmaPlayerCanUseWareHouse", "True"));
				KARMA_MIN_KARMA = Integer.parseInt(other.getProperty("MinKarma", "240"));
				KARMA_MAX_KARMA = Integer.parseInt(other.getProperty("MaxKarma", "10000"));
				KARMA_XP_DIVIDER = Integer.parseInt(other.getProperty("XPDivider", "260"));
				KARMA_LOST_BASE = Integer.parseInt(other.getProperty("BaseKarmaLost", "0"));
				KARMA_DROP_GM = Boolean.parseBoolean(other.getProperty("CanGMDropEquipment", "false"));
				KARMA_AWARD_PK_KILL = Boolean.parseBoolean(other.getProperty("AwardPKKillPVPPoint", "true"));
				KARMA_PK_LIMIT = Integer.parseInt(other.getProperty("MinimumPKRequiredToDrop", "5"));
				KARMA_NONDROPPABLE_PET_ITEMS = other.getProperty("ListOfPetItems", "2375,3500,3501,3502,4422,4423,4424,4425,6648,6649,6650");
				KARMA_NONDROPPABLE_ITEMS = other.getProperty("ListOfNonDroppableItemsForPK", "1147,425,1146,461,10,2368,7,6,2370,2369");
				...
				PVP_NORMAL_TIME = Integer.parseInt(other.getProperty("PvPVsNormalTime", "15000"));
				PVP_PVP_TIME = Integer.parseInt(other.getProperty("PvPVsPvPTime", "30000"));
				
				PARTY_XP_CUTOFF_METHOD = other.getProperty("PartyXpCutoffMethod", "level");
				PARTY_XP_CUTOFF_PERCENT = Double.parseDouble(other.getProperty("PartyXpCutoffPercent", "3."));
				PARTY_XP_CUTOFF_LEVEL = Integer.parseInt(other.getProperty("PartyXpCutoffLevel", "20"));
				ALT_PARTY_RANGE = Integer.parseInt(other.getProperty("AltPartyRange", "1600"));
				ALT_PARTY_RANGE2 = Integer.parseInt(other.getProperty("AltPartyRange2", "1400"));
				
				EVERYBODY_HAS_ADMIN_RIGHTS = Boolean.parseBoolean(other.getProperty("EverybodyHasAdminRights", "False"));
				MASTERACCESS_LEVEL = Integer.parseInt(other.getProperty("MasterAccessLevel", "127"));
				MASTERACCESS_NAME_COLOR = Integer.decode(StringUtil.concat("0x", other.getProperty("MasterNameColor", "00FF00")));
				MASTERACCESS_TITLE_COLOR = Integer.decode(StringUtil.concat("0x", other.getProperty("MasterTitleColor", "00FF00")));
				GM_HERO_AURA = Boolean.parseBoolean(other.getProperty("GMHeroAura", "False"));
				GM_STARTUP_INVULNERABLE = Boolean.parseBoolean(other.getProperty("GMStartupInvulnerable", "True"));
				GM_STARTUP_INVISIBLE = Boolean.parseBoolean(other.getProperty("GMStartupInvisible", "True"));
				GM_STARTUP_SILENCE = Boolean.parseBoolean(other.getProperty("GMStartupSilence", "True"));
				GM_STARTUP_AUTO_LIST = Boolean.parseBoolean(other.getProperty("GMStartupAutoList", "True"));
				
				PETITIONING_ALLOWED = Boolean.parseBoolean(other.getProperty("PetitioningAllowed", "True"));
				MAX_PETITIONS_PER_PLAYER = Integer.parseInt(other.getProperty("MaxPetitionsPerPlayer", "5"));
				MAX_PETITIONS_PENDING = Integer.parseInt(other.getProperty("MaxPetitionsPending", "25"));
				
				IS_CRAFTING_ENABLED = Boolean.parseBoolean(other.getProperty("CraftingEnabled", "True"));
				DWARF_RECIPE_LIMIT = Integer.parseInt(other.getProperty("DwarfRecipeLimit", "50"));
				COMMON_RECIPE_LIMIT = Integer.parseInt(other.getProperty("CommonRecipeLimit", "50"));
				ALT_BLACKSMITH_USE_RECIPES = Boolean.parseBoolean(other.getProperty("AltBlacksmithUseRecipes", "True"));
				
				AUTO_LEARN_SKILLS = Boolean.parseBoolean(other.getProperty("AutoLearnSkills", "false"));
				ALT_GAME_MAGICFAILURES = Boolean.parseBoolean(other.getProperty("MagicFailures", "True"));
				ALT_GAME_SHIELD_BLOCKS = Boolean.parseBoolean(other.getProperty("AltShieldBlocks", "false"));
				ALT_PERFECT_SHLD_BLOCK = Integer.parseInt(other.getProperty("AltPerfectShieldBlockRate", "10"));
				LIFE_CRYSTAL_NEEDED = Boolean.parseBoolean(other.getProperty("LifeCrystalNeeded", "true"));
				SP_BOOK_NEEDED = Boolean.parseBoolean(other.getProperty("SpBookNeeded", "true"));
				ES_SP_BOOK_NEEDED = Boolean.parseBoolean(other.getProperty("EnchantSkillSpBookNeeded", "true"));
				DIVINE_SP_BOOK_NEEDED = Boolean.parseBoolean(other.getProperty("DivineInspirationSpBookNeeded", "true"));
				ALT_GAME_SUBCLASS_WITHOUT_QUESTS = Boolean.parseBoolean(other.getProperty("AltSubClassWithoutQuests", "False"));

				/* Remove equip during subclass change */
				REMOVE_WEAPON_SUBCLASS = Boolean.parseBoolean(other.getProperty("RemoveWeaponSubclass", "False"));
				REMOVE_CHEST_SUBCLASS = Boolean.parseBoolean(other.getProperty("RemoveChestSubclass", "False"));
				REMOVE_LEG_SUBCLASS = Boolean.parseBoolean(other.getProperty("RemoveLegSubclass", "False"));
				
				ENABLE_MODIFY_SKILL_DURATION = Boolean.parseBoolean(other.getProperty("EnableModifySkillDuration", "False"));
				if (ENABLE_MODIFY_SKILL_DURATION)
				{
					String[] propertySplit1 = other.getProperty("SkillDurationList", "").split(";");
					SKILL_DURATION_LIST = new HashMap<>(propertySplit1.length);
				...
				BUFFS_MAX_AMOUNT = Byte.parseByte(other.getProperty("MaxBuffsAmount", "20"));
				STORE_SKILL_COOLTIME = Boolean.parseBoolean(other.getProperty("StoreSkillCooltime", "true"));
				   NEW_PLAYER_BUFFS = Boolean.parseBoolean(other.getProperty("AltNewCharBuffs", "False"));
				   if(NEW_PLAYER_BUFFS)
				   {
				       String[] fighterBuffSplit = other.getProperty("FighterBuffList", "").split(";");
				       ...
				       for(String skill : fighterBuffSplit)
				       {
				        ...
				        if(skillSplit.length != 2)
				        {
				         System.out.println("invalid config property in " + other + " -> FighterBuffList \"" + skill + "\"");
				        }
				        else
				        {
				         try
				         ...
				         catch(NumberFormatException nfe)
				         {
				          if(!skill.equals(""))
				          {
				               System.out.println("invalid config property in " + other + " -> FighterBuffList \"" + skillSplit[0] + "\"" + skillSplit[1]);
				          }
				         }
				        }
				       }

				       String[] mageBuffSplit = other.getProperty("MageBuffList", "").split(";");
				       ...
				       for(String skill : mageBuffSplit)
				       {
				        ...
				        if(skillSplit.length != 2)
				        {
				         System.out.println("invalid config property in " + other + " -> MageBuffList \"" + skill + "\"");
				        }
				        else
				        {
				         try
				         ...
				         catch(NumberFormatException nfe)
				         {
				          if(!skill.equals(""))
				          {
				               System.out.println("invalid config property in" + other + " -> MageBuffList \"" + skillSplit[0] + "\"" + skillSplit[1]);
				          }
				         }
				        }
				       }
					...
					/** Aio System */
					ENABLE_AIO_SYSTEM = Boolean.parseBoolean(other.getProperty("EnableAioSystem", "True"));
					ALLOW_AIO_NCOLOR = Boolean.parseBoolean(other.getProperty("AllowAioNameColor", "True"));
					AIO_NCOLOR = Integer.decode("0x" + other.getProperty("AioNameColor", "88AA88"));
					ALLOW_AIO_TCOLOR = Boolean.parseBoolean(other.getProperty("AllowAioTitleColor", "True"));
					AIO_TCOLOR = Integer.decode("0x" + other.getProperty("AioTitleColor", "88AA88"));
					AIO_ITEMID = Integer.parseInt(other.getProperty("ItemIdAio", "9945"));
					ALLOW_AIO_ITEM = Boolean.parseBoolean(other.getProperty("AllowAIOItem", "False"));
					ALLOW_AIO_USE_CM = Boolean.parseBoolean(other.getProperty("AllowAioUseClassMaster", "False"));
					
					if(ENABLE_AIO_SYSTEM) //create map if system is enabled
					{
						String[] AioSkillsSplit = other.getProperty("AioSkills", "").split(";");
						...
						for (String skill : AioSkillsSplit)
						{
							...
							else
							{
								...
								catch (NumberFormatException nfe)
								{
									if (!skill.equals(""))
									{
										System.out.println("[Aio System]: invalid config property in other.props -> AioSkills \"" + skillSplit[0] + "\"" + skillSplit[1]);
									}
								}
							}
						}
			...
			{
				e.printStackTrace();
				throw new Error("Server failed to load " + OTHER_FILE + " file.");
			}
			...
			try
			{
				...
				DATABASE_URL = server.getProperty("URL", "jdbc:mysql://localhost/xcine");
				...
				FORCE_INVENTORY_UPDATE = Boolean.valueOf(server.getProperty("ForceInventoryUpdate", "False"));
			}
			catch (Exception e)
			{
				e.printStackTrace();
