...
public class GeoEngine extends GeoData
{
	...
	// Public Methods
	/**
	 * @see net.xcine.gameserver.GeoData#getType(int, int)
	 */
	@Override
	...
	/**
	 * @see net.xcine.gameserver.GeoData#getHeight(int, int, int)
	 */
	@Override
	...
	/**
	 * @see net.xcine.gameserver.GeoData#getSpawnHeight(int, int, int, int, L2Spawn)
	 */
	@Override
	...
	/**
	 * @see net.xcine.gameserver.GeoData#geoPosition(int, int)
	 */
	@Override
	...
	/**
	 * @see net.xcine.gameserver.GeoData#canSeeTarget(L2Object, Point3D)
	 */
	@Override
	...
	/**
	 * @see net.xcine.gameserver.GeoData#canSeeTarget(net.xcine.gameserver.model.L2Object, net.xcine.gameserver.model.L2Object)
	 */
	@Override
	...
	/**
	 * @see net.xcine.gameserver.GeoData#canSeeTargetDebug(net.xcine.gameserver.model.actor.instance.L2PcInstance, net.xcine.gameserver.model.L2Object)
	 */
	@Override
	...
	/**
	 * @see net.xcine.gameserver.GeoData#getNSWE(int, int, int)
	 */
	@Override
	...
	/**
	 * @see net.xcine.gameserver.GeoData#moveCheck(int, int, int, int, int, int)
	 */
	@Override
	...
	/**
	 * @see net.xcine.gameserver.GeoData#addGeoDataBug(net.xcine.gameserver.model.actor.instance.L2PcInstance, java.lang.String)
	 */
	@Override
