...
public abstract class L2PlayableAI extends L2CharacterAI
{
	...
	/**
	 * @see net.xcine.gameserver.ai.L2CharacterAI#onIntentionAttack(net.xcine.gameserver.model.actor.L2Character)
	 */
	@Override
	...
	/**
	 * @see net.xcine.gameserver.ai.L2CharacterAI#onIntentionCast(net.xcine.gameserver.model.L2Skill, net.xcine.gameserver.model.L2Object)
	 */
	@Override
