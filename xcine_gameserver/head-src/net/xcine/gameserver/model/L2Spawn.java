...
public class L2Spawn
{
	...
	public L2Spawn(L2NpcTemplate mobTemplate) throws SecurityException, ClassNotFoundException, NoSuchMethodException
	{
		...
		{
			int.class,
			Class.forName("net.xcine.gameserver.templates.chars.L2NpcTemplate")
		};
		_constructor = Class.forName("net.xcine.gameserver.model.actor.instance." + _template.getType() + "Instance").getConstructor(parameters);
	}
