...
import net.xcine.gameserver.model.L2EnchantSkillData;
import net.xcine.gameserver.model.L2EnchantSkillLearn;
import net.xcine.gameserver.model.L2Skill;
import net.xcine.gameserver.model.L2SkillLearn;
import net.xcine.gameserver.model.actor.L2Npc;
import net.xcine.gameserver.model.actor.status.FolkStatus;
import net.xcine.gameserver.model.base.ClassId;
import net.xcine.gameserver.network.SystemMessageId;
import net.xcine.gameserver.network.serverpackets.AcquireSkillList;
...
import net.xcine.gameserver.skills.effects.EffectBuff;
import net.xcine.gameserver.skills.effects.EffectDebuff;
