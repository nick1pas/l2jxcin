...
import net.xcine.gameserver.LoginServerThread;
...
import net.xcine.gameserver.ai.L2PlayerAI;
import net.xcine.gameserver.ai.L2SummonAI;
import net.xcine.gameserver.communitybbs.BB.Forum;
...
import net.xcine.gameserver.instancemanager.DuelManager;
...
import net.xcine.gameserver.model.L2PetData.L2PetLevelData;
...
import net.xcine.gameserver.model.MacroList;
import net.xcine.gameserver.model.PartyMatchRoom;
import net.xcine.gameserver.model.PartyMatchRoomList;
import net.xcine.gameserver.model.PartyMatchWaitingList;
import net.xcine.gameserver.model.ShortCuts;
...
import net.xcine.gameserver.model.actor.appearance.PcAppearance;
import net.xcine.gameserver.model.actor.knownlist.PcKnownList;
import net.xcine.gameserver.model.actor.position.PcPosition;
import net.xcine.gameserver.model.actor.stat.PcStat;
import net.xcine.gameserver.model.actor.status.PcStatus;
...
import net.xcine.gameserver.model.itemcontainer.ItemContainer;
import net.xcine.gameserver.model.itemcontainer.PcFreight;
import net.xcine.gameserver.model.itemcontainer.PcInventory;
import net.xcine.gameserver.model.itemcontainer.PcWarehouse;
...
import net.xcine.gameserver.network.serverpackets.AbstractNpcInfo;
import net.xcine.gameserver.network.serverpackets.ActionFailed;
import net.xcine.gameserver.network.serverpackets.ChangeWaitType;
import net.xcine.gameserver.network.serverpackets.CharInfo;
...
import net.xcine.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import net.xcine.gameserver.network.serverpackets.ExFishingEnd;
import net.xcine.gameserver.network.serverpackets.ExFishingStart;
import net.xcine.gameserver.network.serverpackets.ExOlympiadMode;
import net.xcine.gameserver.network.serverpackets.ExSetCompassZoneCode;
...
import net.xcine.gameserver.network.serverpackets.GetOnVehicle;
...
import net.xcine.gameserver.network.serverpackets.LeaveWorld;
...
import net.xcine.gameserver.network.serverpackets.ObservationMode;
...
import net.xcine.gameserver.network.serverpackets.PrivateStoreListBuy;
import net.xcine.gameserver.network.serverpackets.PrivateStoreListSell;
import net.xcine.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import net.xcine.gameserver.network.serverpackets.PrivateStoreManageListSell;
import net.xcine.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import net.xcine.gameserver.network.serverpackets.PrivateStoreMsgSell;
import net.xcine.gameserver.network.serverpackets.RecipeShopManageList;
import net.xcine.gameserver.network.serverpackets.RecipeShopMsg;
import net.xcine.gameserver.network.serverpackets.RecipeShopSellList;
import net.xcine.gameserver.network.serverpackets.RelationChanged;
import net.xcine.gameserver.network.serverpackets.Ride;
import net.xcine.gameserver.network.serverpackets.SendTradeDone;
...
import net.xcine.gameserver.network.serverpackets.ShortBuffStatusUpdate;
...
import net.xcine.gameserver.network.serverpackets.SkillList;
import net.xcine.gameserver.network.serverpackets.Snoop;
...
import net.xcine.gameserver.network.serverpackets.TargetSelected;
import net.xcine.gameserver.network.serverpackets.TargetUnselected;
...
import net.xcine.gameserver.skills.effects.EffectTemplate;
import net.xcine.gameserver.skills.l2skills.L2SkillSiegeFlag;
import net.xcine.gameserver.skills.l2skills.L2SkillSummon;
import net.xcine.gameserver.taskmanager.AttackStanceTaskManager;
import net.xcine.gameserver.taskmanager.PvpFlagTaskManager;
import net.xcine.gameserver.taskmanager.TakeBreakTaskManager;
import net.xcine.gameserver.taskmanager.WaterTaskManager;
import net.xcine.gameserver.templates.chars.L2PcTemplate;
import net.xcine.gameserver.templates.item.L2ActionType;
import net.xcine.gameserver.templates.item.L2Armor;
import net.xcine.gameserver.templates.item.L2ArmorType;
...
import net.xcine.gameserver.util.FloodProtectors;
...
public final class L2PcInstance extends L2Playable
{
	...
	private static final byte TOWN = 0;
	...
	public PcFreight getDepositedFreight(int objectId)
	{
		if (_depositedFreight == null)
			_depositedFreight = new ArrayList<>();
		else
		{
	...
	/**
	 * @see net.xcine.gameserver.model.actor.L2Character#enableSkill(net.xcine.gameserver.model.L2Skill)
	 */
	@Override
	...
	/**
	 * @see net.xcine.gameserver.model.actor.L2Character#checkDoCastConditions(net.xcine.gameserver.model.L2Skill)
	 */
	@Override
	 ...
	 * <BR>
	 * <li>Send MyTargetSelected to the player (display the select window)</li> <li>If this L2PcInstance has a Private Store, notify the player AI with AI_INTENTION_INTERACT</li> <li>If this L2PcInstance is autoAttackable, notify the player AI with AI_INTENTION_ATTACK</li><BR>
	 * <BR>
	...
	public final void broadcastCharInfo()
	{
		for (L2PcInstance player : getKnownList().getKnownPlayers())
		{
			...
			Integer oldrelation = getKnownList().getKnownRelationsMap().get(player.getObjectId());
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>If the attacker/target is dead or use fake death, notify the AI with EVT_CANCEL and send ActionFailed (if attacker is a L2PcInstance)</li> <li>If attack isn't aborted, send a message system (critical hit, missed...) to attacker/target if they are L2PcInstance</li> <li>If attack isn't
	 * aborted and hit isn't missed, reduce HP of the target and calculate reflection damage to reduce HP of attacker if necessary</li> <li>if attack isn't aborted and hit isn't missed, manage attack or cast break of the target (calculating rate, sending message...)</li><BR>
	 * <BR>
	...
	public final void onTeleported()
	{
        ...
        if (isAio() && !isGM() && (!isInsideZone(TOWN)))
        {
	...
	public void sendInfo(L2PcInstance activeChar)
	{
		...
		Integer oldrelation = getKnownList().getKnownRelationsMap().get(activeChar.getObjectId());
		...
		oldrelation = activeChar.getKnownList().getKnownRelationsMap().get(getObjectId());
