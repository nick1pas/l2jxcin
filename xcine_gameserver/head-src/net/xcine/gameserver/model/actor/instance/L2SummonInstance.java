...
import net.xcine.gameserver.network.serverpackets.SetSummonRemainTime;
...
public class L2SummonInstance extends L2Summon
{
	 ...
	 * @see net.xcine.gameserver.model.actor.L2Character#doCast(net.xcine.gameserver.model.L2Skill)
	 */
	@Override
