...
import net.xcine.gameserver.model.actor.instance.L2DecoInstance;
...
import net.xcine.gameserver.taskmanager.ExclusiveTask;
...
public class BanditStrongholdSiege extends ClanHallSiege
{
	...
	public Map<Integer, clanPlayersInfo> _clansInfo = new HashMap<>();
	private L2ClanHallZone zone;
	public ClanHall clanhall = ClanHallManager.getInstance().getClanHallById(35);
	public clanPlayersInfo _ownerClanInfo = new clanPlayersInfo();
	...
	public final ExclusiveTask _startSiegeTask = new ExclusiveTask()
	{
		@Override
