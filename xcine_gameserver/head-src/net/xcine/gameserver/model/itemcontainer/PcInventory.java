...
import net.xcine.gameserver.model.TradeList.TradeItem;
...
public class PcInventory extends Inventory
{
	 ...
	 * @param itemId
	 * @return
	 * @see net.xcine.gameserver.model.itemcontainer.PcInventory#getAllItemsByItemId(int, boolean)
	 */
	 ...
	 * @param enchantment
	 * @return
	 * @see net.xcine.gameserver.model.itemcontainer.PcInventory#getAllItemsByItemId(int, int, boolean)
	 */
