...
import net.xcine.gameserver.ai.NextAction;
import net.xcine.gameserver.ai.NextAction.NextActionCallback;
...
import net.xcine.gameserver.network.serverpackets.ChairSit;
...
public final class RequestActionUse extends L2GameClientPacket
{
	...
	private void useSkill(int skillId, L2Object target)
	{
		...
		if (activeSummon != null && !activeSummon.isBetrayed())
		{
			...
			final TIntObjectHashMap<L2Skill> _skills = activeSummon.getTemplate().getSkills();
