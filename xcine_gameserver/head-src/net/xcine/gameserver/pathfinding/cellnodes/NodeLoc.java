 ...
 */
package net.xcine.gameserver.pathfinding.cellnodes;
...
public class NodeLoc extends AbstractNodeLoc
{
	...
	/**
	 * @see net.xcine.gameserver.pathfinding.AbstractNodeLoc#getX()
	 */
	@Override
	public int getX()
	{
	...
	/**
	 * @see net.xcine.gameserver.pathfinding.AbstractNodeLoc#getY()
	 */
	@Override
	public int getY()
	{
	...
	/**
	 * @see net.xcine.gameserver.pathfinding.AbstractNodeLoc#getZ()
	 */
	@Override
	public short getZ()
	{
	...
	/**
	 * @see net.xcine.gameserver.pathfinding.AbstractNodeLoc#getNodeX()
	 */
	@Override
	public int getNodeX()
	{
	...
	/**
	 * @see net.xcine.gameserver.pathfinding.AbstractNodeLoc#getNodeY()
	 */
	@Override
	public int getNodeY()
	{
