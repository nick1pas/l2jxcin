...
import net.xcine.gameserver.model.ChanceCondition;
import net.xcine.gameserver.model.L2Skill;
import net.xcine.gameserver.model.base.Race;
import net.xcine.gameserver.skills.basefuncs.FuncTemplate;
import net.xcine.gameserver.skills.basefuncs.Lambda;
import net.xcine.gameserver.skills.basefuncs.LambdaCalc;
import net.xcine.gameserver.skills.basefuncs.LambdaConst;
import net.xcine.gameserver.skills.basefuncs.LambdaStats;
import net.xcine.gameserver.skills.conditions.Condition;
import net.xcine.gameserver.skills.conditions.ConditionElementSeed;
import net.xcine.gameserver.skills.conditions.ConditionForceBuff;
import net.xcine.gameserver.skills.conditions.ConditionGameTime;
import net.xcine.gameserver.skills.conditions.ConditionGameTime.CheckGameTime;
import net.xcine.gameserver.skills.conditions.ConditionLogicAnd;
import net.xcine.gameserver.skills.conditions.ConditionLogicNot;
import net.xcine.gameserver.skills.conditions.ConditionLogicOr;
import net.xcine.gameserver.skills.conditions.ConditionPlayerActiveEffectId;
import net.xcine.gameserver.skills.conditions.ConditionPlayerActiveSkillId;
import net.xcine.gameserver.skills.conditions.ConditionPlayerCharges;
import net.xcine.gameserver.skills.conditions.ConditionPlayerHasCastle;
import net.xcine.gameserver.skills.conditions.ConditionPlayerHasClanHall;
import net.xcine.gameserver.skills.conditions.ConditionPlayerHp;
import net.xcine.gameserver.skills.conditions.ConditionPlayerHpPercentage;
import net.xcine.gameserver.skills.conditions.ConditionPlayerInvSize;
import net.xcine.gameserver.skills.conditions.ConditionPlayerIsHero;
import net.xcine.gameserver.skills.conditions.ConditionPlayerLevel;
import net.xcine.gameserver.skills.conditions.ConditionPlayerMp;
import net.xcine.gameserver.skills.conditions.ConditionPlayerPkCount;
import net.xcine.gameserver.skills.conditions.ConditionPlayerPledgeClass;
import net.xcine.gameserver.skills.conditions.ConditionPlayerRace;
import net.xcine.gameserver.skills.conditions.ConditionPlayerSex;
import net.xcine.gameserver.skills.conditions.ConditionPlayerState;
import net.xcine.gameserver.skills.conditions.ConditionPlayerState.CheckPlayerState;
import net.xcine.gameserver.skills.conditions.ConditionPlayerWeight;
import net.xcine.gameserver.skills.conditions.ConditionSkillStats;
import net.xcine.gameserver.skills.conditions.ConditionSlotItemId;
import net.xcine.gameserver.skills.conditions.ConditionTargetActiveEffectId;
import net.xcine.gameserver.skills.conditions.ConditionTargetActiveSkillId;
import net.xcine.gameserver.skills.conditions.ConditionTargetAggro;
import net.xcine.gameserver.skills.conditions.ConditionTargetClassIdRestriction;
import net.xcine.gameserver.skills.conditions.ConditionTargetHpMinMax;
import net.xcine.gameserver.skills.conditions.ConditionTargetLevel;
import net.xcine.gameserver.skills.conditions.ConditionTargetNpcId;
import net.xcine.gameserver.skills.conditions.ConditionTargetRaceId;
import net.xcine.gameserver.skills.conditions.ConditionTargetUsesWeaponKind;
import net.xcine.gameserver.skills.conditions.ConditionUsingItemType;
import net.xcine.gameserver.skills.conditions.ConditionUsingSkill;
import net.xcine.gameserver.skills.conditions.ConditionWithSkill;
import net.xcine.gameserver.skills.effects.EffectChanceSkillTrigger;
