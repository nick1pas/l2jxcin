...
public class ConditionLogicAnd extends Condition
{
	 ...
	 * @see net.xcine.gameserver.skills.conditions.Condition#setListener(net.xcine.gameserver.skills.conditions.ConditionListener)
	 */
	@Override
	 ...
	 * @see net.xcine.gameserver.skills.conditions.Condition#testImpl(net.xcine.gameserver.skills.Env)
	 */
	@Override
