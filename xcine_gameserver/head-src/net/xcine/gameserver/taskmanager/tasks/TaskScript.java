...
public class TaskScript extends Task
{
	...
	/**
	 * @see net.xcine.gameserver.taskmanager.models.Task#getName()
	 */
	@Override
	...
	/**
	 * @see net.xcine.gameserver.taskmanager.models.Task#onTimeElapsed(net.xcine.gameserver.taskmanager.TaskManager.ExecutedTask)
	 */
	@Override
