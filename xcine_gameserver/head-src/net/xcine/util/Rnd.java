...
public final class Rnd
{
	...
	public static final class RandomContainer
	{
		 ...
		 * @see net.xcine.util.Rnd#nextDouble()
		 */
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link net.xcine.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see net.xcine.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see net.xcine.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
